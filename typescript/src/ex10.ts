...
const add2: Operation = (a: number, b: number) => a + b
const sub2: Operation = (a: number, b: number) => a - b
const mul2: Operation = (a: number, b: number) => a * b
const div2: Operation = (a: number, b: number) => a / b
