...
function Button(props) {
  return <button onClick={props.onClickFunc}>클릭하세여</button>;
}
...
export function Props2() {
  ...
  return (
    <div>
      {/* 여기서 handledClick 사용시. ()소괄호는 넣지 않음*/}
      {/* 함수 이름만 전달하기 때문 */}
