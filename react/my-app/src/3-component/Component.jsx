...
class GreetingClass extends React.Component {
  render() {
    // 자주 나오니까 잘 알고 있기@
    // 오버라이딩 (over ride) : 부모 클래스의 자식 클래스가 재정의한다.
    // 오버로딩 (over loading) : 함수(메서드)의 매개변수의 갯수와 타입을 다르게 함으로 확장하는 것
    return (
      // return이 한 줄 일 경우 prettier가 ()를 없앰 / ()는 써버릇하기
      <h1>hello react component!{this.props.name}</h1>
    );
  }
}
// 위와 같은 경우 데이터 건네주는 부분 : <GreetingClass name="hong"/>
