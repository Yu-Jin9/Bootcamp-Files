// 다형성 : 폴리모피즘
//       : 자식클래스 객쳇가 자기 클래스 또는 보모클래스의 타입을 모두 가질 수 있는 것
// 이유   : 타입의 유연성을 가지기 위해서
//       : 타입이 정확하지 않더라도 객체(침조변수)를 전달 가능
class Parent {
    String name = "Parent";
    void parentMethod() {
...
public class Ex35 {
    public static void main(String[] args) {
        ...
        // 2. 다운 캐스팅(Down Cast) : 자식객체가 자식클래스 타입을 가지는 것
        Child c2 = (Child)p2;
        ...
        Parent c =  new Child();
        Child d = (Child)c;
        // 이 경우는 불가능 : Child는 이미 Parent의 상속을 받았기 때문
        // Child e = new Parent();
